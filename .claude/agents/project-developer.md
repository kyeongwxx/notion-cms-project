...
export default function AuthenticatedLayout({
  ...
  return (
    <div className="min-h-screen">
      <NavigationMenu>{/* 네비게이션 항목 */}</NavigationMenu>
...
export default async function Page({
  ...
  return <div>{/* TODO: 페이지 콘텐츠 구현 */}</div>;
}
